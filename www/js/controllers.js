...
$scope.products=[];
for(var i=0;i< 5;i++){
  $scope.products.push({img:"https://staticdelivery.nexusmods.com/mods/110/images/74627-0-1459502036.jpg",name:"Apple"+i,price:"5$"});
}
...
$scope.product = $scope.products[$stateParams.loc];
}])
